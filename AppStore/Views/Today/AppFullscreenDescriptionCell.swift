...
class AppFullscreenDescriptionCell: UITableViewCell {
    ...
    let descriptionLabel: UILabel = {
        ...
        let attributedText = NSMutableAttributedString(string: "Great games", attributes: [.foregroundColor: UIColor.label, .font: UIFont.boldSystemFont(ofSize: 20)])
        ...
        attributedText.append(NSAttributedString(string: "\n\n\nHeroic adventure", attributes: [.foregroundColor: UIColor.label, .font: UIFont.boldSystemFont(ofSize: 20)]))
